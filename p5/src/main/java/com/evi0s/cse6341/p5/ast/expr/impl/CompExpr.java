...
public class CompExpr extends CondExpr {
    ...
    public void abstractEvaluate() {
        ...
        switch (op) {
            case GE -> this.evaluatedAbstractType = AbstractEvaluator.getGeOpType(expr1.evaluatedAbstractType, expr2.evaluatedAbstractType);
            case GT -> this.evaluatedAbstractType = AbstractEvaluator.getGtOpType(expr1.evaluatedAbstractType, expr2.evaluatedAbstractType);
            case LE -> this.evaluatedAbstractType = AbstractEvaluator.getLeOpType(expr1.evaluatedAbstractType, expr2.evaluatedAbstractType);
            case LT -> this.evaluatedAbstractType = AbstractEvaluator.getLtOpType(expr1.evaluatedAbstractType, expr2.evaluatedAbstractType);
            case EQ -> this.evaluatedAbstractType = AbstractEvaluator.getEqOpType(expr1.evaluatedAbstractType, expr2.evaluatedAbstractType);
            case NE -> this.evaluatedAbstractType = AbstractEvaluator.getNeOpType(expr1.evaluatedAbstractType, expr2.evaluatedAbstractType);
        }
    }
}
